...
parameters:
  ...
  properties:
    phase:
      type: string
      enum: [framework, report]
      description: "Which phase of the skill to execute: 'framework' to generate the initial research skeleton and data collection requirements, or 'report' to compile the final analysis report."
    subject:
      type: string
      description: "The research subject or topic (e.g. 'EV market trends 2026')."
    data:
      type: string
      description: "Required for 'report' phase. The gathered raw data, search summaries, or facts to compile into the final report."
  required:
    - phase
    - subject
---
