---
name: deep-research
description: Performs systematic, multi-angle web research on a specific topic or query by executing parallel search passes.
parameters:
  type: object
  properties:
    query:
      type: string
      description: The topic or research query to investigate in depth.
  required:
    - query
---
